    ...
    <div className='bg-white rounded-xl shadow-lg p-6 border border-gray-100 sticky top-4'>
       ...
       <div className='space-y-3'>
        {hostParticipants.map((p) => (
          <div key={p.userId || p.userName} className='p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100'>
          ...
          <>
            <div className='pt-1 border-t border-gray-200'>
              ...
              {otherParticipants.map((p) => (
                <div key={p.userId || p.userName} className='p-3 bg-white rounded-lg border border-gray-200 flex items-center mb-2'>
